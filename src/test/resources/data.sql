insert into Customer (id, email, firstname, lastname) values (1, 'u1@mail.com', 'Dog', 'Snoopy');
insert into Customer (id, email, firstname, lastname) values (2, 'u2@icloud.com', 'John', 'Doe');
insert into Customer (id, email, firstname, lastname) values (3, 'u3@gmail.com', 'Marylyn', 'Monroe');
